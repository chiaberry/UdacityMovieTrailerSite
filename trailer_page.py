...
habla_con_ella = movies.Movie("Hable Con Ella", "Two men bond over their love for two comatose women.", 
                                        "http://www.gstatic.com/tv/thumb/movieposters/31117/p31117_p_v8_aa.jpg", 
...
nine_to_five = movies.Movie("9 to 5", "Three secretaries deal with their misogynistic boss", 
...
romancing_stone = movies.Movie("Romancing the Stone", "A Romance writer teams up with a mercenary to rescue her sister.", 
                                            "https://upload.wikimedia.org/wikipedia/en/thumb/8/84/Romancing_the_stone.jpg/220px-Romancing_the_stone.jpg", 
                                            "https://www.youtube.com/watch?v=WokoWHHAxp4")
johnny_guitar = movies.Movie("Johnny Guitar", "Colorful western noir",
                                    "http://t1.gstatic.com/images?q=tbn:ANd9GcTgnr0HnWzf-X3IQtLtKkUKQVPeICfGA0bgX2gTyR91D--NJiZP",
                                    "https://www.youtube.com/watch?v=ACgSyxdV9vE")
big_trouble_china = movies.Movie("Big Trouble in Little China", "Jack Burton saves Chinatown", 
                                            "http://t1.gstatic.com/images?q=tbn:ANd9GcSoqgsX65XvcSJuFlZ7kTSqRe3uSSpCjeklW-XudHB1TM0ej2e0",
